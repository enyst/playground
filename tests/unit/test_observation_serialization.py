...
def test_recall_observation_serialization():
    ...
    assert observation_instance.runtime_hosts == {'host1': 8080, 'host2': 8081}
    assert observation_instance.repo_instructions == 'complex_repo_instructions'
    assert observation_instance.microagent_knowledge == []
    ...
    assert serialized['extras']['runtime_hosts'] == {'host1': 8080, 'host2': 8081}
    assert serialized['extras']['repo_instructions'] == 'complex_repo_instructions'
    assert serialized['extras']['microagent_knowledge'] == []
...
def test_recall_observation_microagent_knowledge_serialization():
    ...
    assert observation_instance.repo_name == ''
    assert observation_instance.repo_directory == ''
    assert observation_instance.repo_instructions == ''
    assert observation_instance.runtime_hosts == {}
    ...
    assert serialized['extras']['repo_name'] == ''
    assert serialized['extras']['repo_directory'] == ''
    assert serialized['extras']['repo_instructions'] == ''
