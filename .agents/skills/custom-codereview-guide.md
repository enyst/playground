...
The mock-LLM, Docker mock-LLM, and live LLM-backed E2E suites run after changes
reach `main`, not from PR labels. If a risky PR needs pre-merge E2E evidence,
recommend manually dispatching the relevant workflow against the PR branch.
