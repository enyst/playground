...
def create_conversation_with_message(
    custom_message: str, repository: str = 'All-Hands-AI/OpenHands'
):
    ...
    data = {'initial_user_msg': full_message, 'repository': repository}
    ...
    try:
        response = requests.post(
            f'{base_url}/api/conversations', headers=headers, json=data
        )
                ...
                try:
                    ...
                    for event in events:
                        if (
                            ...
                            and 'tool_call_metadata' in event
                        ):
...
if __name__ == '__main__':
    if len(sys.argv) != 2:
        ...
        print(
            "Example: python create_conversation.py 'Please help me fix the failing tests in the CI'"
        )
        sys.exit(1)
